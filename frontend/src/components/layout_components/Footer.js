    ...
    <div className="container">
      <Row className="justify-content-lg-center">
        <Col
          md={12}
          lg={5}
          className="d-flex justify-content-lg-start justify-content-center mb-lg-0 mb-2"
        >
          <div
            className="footer-copyright text-center bg-transparent"
            style={{ letterSpacing: "0.5px", fontSize: "15px" }}
          >
            © 2024 Copyright:
            <a href="#header-section" className="footer-business-name">
              Ashwattha Architects
            </a>
          </div>
        </Col>
        <Col
